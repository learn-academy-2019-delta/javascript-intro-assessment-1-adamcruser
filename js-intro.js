...
//         if (str2[i].notCats==="mouse"){
//             newStr.search(str2[i])
//           }
//         }
//         return newStr
//     }
//     getOthers(toonimals)
//     console.log(getOthers(toonimals))

//this is the wrong way to do it nor do i believe i solved it but I am not sure how to actually get the correct answer. I've looked up different built-in methods for JavaScript but have failed to answer this question. If possible I would like to go over this question with whomever looks the assessments over.
